...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="data:image/svg+xml;base64,">
...
>
> 💻 Passionate about **Software Engineering** and **Full Stack Development**, with a growing specialization in **Data Analytics & Business Intelligence**.
>
> 🚀 I build **scalable applications** that solve real-world problems — and use **data** to explain why they work.
>
...
`RAW DATA` → `CLEANING` → `EXPLORATION` → `ANALYSIS` → `VISUALIZATION` → `BUSINESS INSIGHTS`
...
<td width="33%" align="center"><b>📊 Data Analytics</b><br/><sub>Excel, SQL, Python, Pandas, Power BI, BI</sub></td>
</tr>
</table>
...
<a href="https://leetcode.com/u/santhoshts/"><img src="https://leetcard.jacoblin.cool/santhoshts?theme=dark&font=Nunito"/></a>
...
<sub>
<b>Note:</b> this is a single self-contained README — the banner and dividers are inlined as base64 SVG (no external assets folder needed). The Certifications/Experience sections are intentionally left as labeled placeholders rather than filled with invented content.
</sub>
