...
export const projects = [
  {
    ...
    tag: "AI · Aquaculture",
    description:
      "AI-powered aquaculture monitoring platform that predicts harmful algal bloom risks and gives intelligent recommendations to fish and shrimp farmers.",
    stack: ["Python", "Machine Learning", "React", "REST API"],
    achievements: [
      "Real-time water-quality risk scoring",
      "Recommendation engine for farm operators",
      "End-to-end ML + product pipeline",
    ],
...
export const timeline = [
  {
    ...
    body: "Wrote first lines of code, discovered the craft of building software and solving problems through logic.",
    year: "2022",
    icon: "code",
  },
  {
    title: "Learning DSA & CS Fundamentals",
    body: "Solved 300+ problems across arrays, graphs, DP and system thinking while mastering core CS concepts.",
    year: "2023",
    icon: "brain",
  },
  {
