...
export const stats = [
  ...
  { value: "3", label: "Data & Software Projects" },
...
export const projects = [
  {
    ...
    tag: "AI · Healthcare",
    description:
      "AI-powered healthcare platform that analyzes medical reports using OCR and AI, explains findings in simple language, and provides general health guidance.",
    stack: ["JavaScript"],
    features: [
    ...
    github: "https://github.com/SANTHOSHSIVA55/medi-ai-health-assistant",
    website: "https://medi-ai-health-assistant.vercel.app",
    duration: "3 weeks",
    role: "Solo project",
    impact: [],
  },
  {
    ...
    description:
      "Analytics platform that converts business questions into database insights, generates dashboards, and explains data through interactive visualizations.",
  ...
  },
  {
    ...
    description:
      "Data-driven platform for water-quality analysis, predictive analytics, and environmental risk scoring.",
    stack: ["Python", "Pandas", "React", "REST API", "Matplotlib"],
    features: [
      "10K+ environmental data points",
