...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Santhosh T S — Software Engineer & Full Stack Developer in Chennai building scalable applications and intelligent systems." },
      { name: "author", content: "Santhosh T S" },
      { name: "theme-color", content: "#0b0f1a" },
      { property: "og:title", content: "Santhosh T S — Software Engineer & Full Stack Developer" },
      { property: "og:description", content: "Crafting scalable software, robust backend systems, and intelligent applications." },
