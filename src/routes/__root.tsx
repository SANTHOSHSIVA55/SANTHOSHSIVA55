...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Santhosh T S — Software Engineer, Full Stack Developer, and Data Analyst in Chennai building scalable software and data analytics solutions." },
      { name: "author", content: "Santhosh T S" },
      { name: "theme-color", media: "(prefers-color-scheme: dark)", content: "#0b0f1a" },
      { name: "theme-color", media: "(prefers-color-scheme: light)", content: "#f0f2f5" },
      { property: "og:title", content: "Santhosh T S — Software Engineer | Full Stack Developer | Data Analyst" },
      { property: "og:description", content: "Crafting scalable software, insightful data products, and intelligent systems." },
