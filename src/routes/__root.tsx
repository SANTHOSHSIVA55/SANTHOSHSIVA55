...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Santhosh T S — Full Stack Developer and Data Analyst in Chennai building scalable software and data analytics solutions." },
